...
import by.bsu.dependency.cyclical.CyclicalBean1;
import by.bsu.dependency.cyclical.CyclicalBean2;
...
class SimpleApplicationContextTest {
    ...
    void testCyclicalDependencies() {
        ...
        ApplicationContext cyclicalContext = new SimpleApplicationContext(CyclicalBean1.class, CyclicalBean2.class);
